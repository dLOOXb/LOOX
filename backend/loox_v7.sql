...
--
-- Host: localhost:3306
-- Generation Time: Feb 07, 2017 at 08:30 AM
...
--
-- Dumping data for table `behandlare`
--

INSERT INTO `behandlare` (`id`, `fornamn`, `efternamn`, `salongnamn`, `alias`, `foto`, `info`, `instagram`, `facebook`, `twitter`, `pintrest`) VALUES
(1, 'Testare', 'Testsson', 'Den testande salongen', NULL, 'http://3.bp.blogspot.com/-FYJf-5nWvU8/UXQKqGjkt4I/AAAAAAAAMrk/hbdjl0FXlmw/s1600/1roxette.jpg', 'Det här är en testperson.', NULL, NULL, NULL, NULL);
...
INSERT INTO `salong` (`id`, `salongnamn`, `info`, `url`, `email`, `tel`, `gata`, `postnummer`, `ort`, `instagram`, `facebook`, `twitter`, `pintrest`) VALUES
(1, 'Den testande salongen', NULL, NULL, 'hello@test.se', '035036047', 'Testgatan 3', '000 00', 'Ort', '', '', '', '');
