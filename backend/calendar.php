    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        <div>
            ...
            <table border='1' align='center' style='font-size:18px;'>
                <tr>
                    <td align='center'><input style='width:50px' type='button' value='<' class='btn btn-black'
                                              name='previousbutton'
                                              onclick="goLastMonth(<?php echo $month . " , " . $year ?>)"/></td>
                    <td colspan='5' align='center'>
                        <?php echo $monthName . ", " . $year;
                        ?> </td>
                    <td align='center'><input style='width:50px' type='button' value='>' class='btn btn-black'
                                              name='nextbutton'
                                              onclick="goNextMonth(<?php echo $month . " , " . $year ?>)"/></td>
                </tr>
