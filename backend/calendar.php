                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../html/saloons_hairdressers.html">Visa företag och frisörer</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="../html/registersaloon.html">Registrera företag</a></li>
                            <li><a href="../html/registerhairdresser.html">Registrera frisör</a></li>
                        </ul>
                </ul>
